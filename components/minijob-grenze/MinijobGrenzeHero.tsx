...
export default function MinijobGrenzeHero() {
  const navLinks = [
    { href: '#grenze-2026', label: '↓ Grenze 2026' },
    { href: '#berechnung', label: '↓ Berechnung' },
    { href: '#aenderungen', label: '↓ Änderungen' },
    { href: '#faq', label: '↓ FAQ' },
  ]
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-6">
          <div className="flex-1 min-w-0">
            <h1 className="text-lg sm:text-2xl font-bold text-white leading-tight mb-1">
              Minijob Grenze 2026 – 603 Euro Verdienstgrenze aktuell
            </h1>
            <p className="text-xs sm:text-sm text-blue-100 leading-relaxed">
              Die <strong className="text-white">Minijob-Grenze 2026</strong> beträgt{' '}
              <strong className="text-white">603 Euro pro Monat</strong> (7.236 Euro/Jahr) — gekoppelt an den neuen{' '}
              <span className="text-blue-200">Mindestlohn von 13,90 Euro/Stunde</span>. Alle aktuellen Regelungen,
              Stundengrenzen, Arbeitgeberkosten und Änderungen gegenüber 2025 auf einen Blick.
            </p>
          </div>
