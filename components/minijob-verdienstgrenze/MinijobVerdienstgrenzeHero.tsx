...
export default function MinijobVerdienstgrenzeHero() {
  const navLinks = [
    { href: '#verdienstgrenze-2026', label: '↓ Grenze 2026' },
    { href: '#berechnung', label: '↓ Berechnung' },
    { href: '#ueberschreitung', label: '↓ Überschreitung' },
    { href: '#faq', label: '↓ FAQ' },
  ]
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-6">
          <div className="flex-1 min-w-0">
            <h1 className="text-lg sm:text-2xl font-bold text-white leading-tight mb-1">
              Minijob Verdienstgrenze 2026 – 603 Euro pro Monat aktuell
            </h1>
            <p className="text-xs sm:text-sm text-blue-100 leading-relaxed">
              Die <strong className="text-white">Minijob Verdienstgrenze 2026</strong> beträgt{' '}
              <strong className="text-white">603 Euro pro Monat</strong> (7.236 Euro/Jahr) — dynamisch
              gekoppelt an den <span className="text-blue-200">Mindestlohn von 13,90 Euro/Stunde</span>.
              Was erlaubt ist, wann die Grenze überschritten werden darf und was 2027 kommt.
            </p>
          </div>
